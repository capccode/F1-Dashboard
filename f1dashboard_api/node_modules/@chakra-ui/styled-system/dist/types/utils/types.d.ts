...
export type Token<CSSType, ThemeKey = unknown> = ThemeKey extends keyof ThemeTypings ? ResponsiveValue<CSSType | ThemeTypings[ThemeKey]> : ResponsiveValue<CSSType>;
export type CSSMap = Record<string, {
    value: string;
    var: string;
    varRef: string;
}>;
export type Transform = (value: any, theme: CssTheme, styles?: Record<string, any>) => any;
