...
const [NumberInputStylesProvider, useNumberInputStyles] = context.createContext({
  name: `NumberInputStylesContext`,
  errorMessage: `useNumberInputStyles returned is 'undefined'. Seems you forgot to wrap the components in "<NumberInput />" `
});
const [NumberInputProvider, useNumberInputContext] = context.createContext({
  ...
  function NumberInput2(props, ref) {
    ...
    return /* @__PURE__ */ jsxRuntime.jsx(NumberInputProvider, { value: ctx, children: /* @__PURE__ */ jsxRuntime.jsx(NumberInputStylesProvider, { value: styles, children: /* @__PURE__ */ jsxRuntime.jsx(
      factory.chakra.div,
      {
        ...htmlProps,
        ref,
        className: cx.cx("chakra-numberinput", props.className),
        __css: {
          position: "relative",
          zIndex: 0,
          ...styles.root
...
const NumberInputField = forwardRef.forwardRef(
  function NumberInputField2(props, ref) {
    ...
    return /* @__PURE__ */ jsxRuntime.jsx(
      ...
      {
        ...input,
        className: cx.cx("chakra-numberinput__field", props.className),
        __css: {
          width: "100%",
          ...styles.field
        }
