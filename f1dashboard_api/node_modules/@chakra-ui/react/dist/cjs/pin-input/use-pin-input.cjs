...
const [PinInputProvider, usePinInputContext] = context.createContext({
...
function usePinInput(props = {}) {
  ...
  const [values, setValues] = useControllableState.useControllableState({
  ...
  const getInputProps = react.useCallback(
    (props2) => {
      ...
      return {
        ...
        onChange: callAll.callAllHandlers(rest.onChange, onChange2),
        onKeyDown: callAll.callAllHandlers(rest.onKeyDown, onKeyDown),
        onFocus: callAll.callAllHandlers(rest.onFocus, onFocus),
        onBlur: callAll.callAllHandlers(rest.onBlur, onBlur),
        value: values[index] || "",
...
function usePinInputField(props = {}, ref = null) {
  ...
  return getInputProps({
    ...props,
    ref: useMergeRefs.mergeRefs(register, ref),
    index
  });
}
