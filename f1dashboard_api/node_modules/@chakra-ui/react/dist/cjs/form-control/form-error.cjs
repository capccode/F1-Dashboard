...
const [FormErrorStylesProvider, useFormErrorStyles] = context.createContext({
  ...
  (props, ref) => {
    ...
    return /* @__PURE__ */ jsxRuntime.jsx(FormErrorStylesProvider, { value: styles, children: /* @__PURE__ */ jsxRuntime.jsx(
      factory.chakra.div,
      {
        ...
        className: cx.cx("chakra-form__error-message", props.className),
        __css: {
          display: "flex",
          alignItems: "center",
          ...styles.text
...
const FormErrorIcon = forwardRef.forwardRef((props, ref) => {
  ...
  if (!field?.isInvalid)
    return null;
  const _className = cx.cx("chakra-form__error-icon", props.className);
