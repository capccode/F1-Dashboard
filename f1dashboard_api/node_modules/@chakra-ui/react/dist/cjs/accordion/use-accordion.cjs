...
var warn = require('@chakra-ui/utils/warn');
...
function useAccordion(props) {
  ...
  const [index, setIndex] = useControllableState.useControllableState({
    value: indexProp,
    defaultValue() {
      if (allowMultiple)
        return defaultIndex ?? [];
...
const [AccordionProvider, useAccordionContext] = context.createContext({
  ...
  const getButtonProps = react.useCallback(
    function getButtonProps2(props2 = {}, ref = null) {
      return {
        ...props2,
        type: "button",
        ref: useMergeRefs.mergeRefs(register, buttonRef, ref),
        id: buttonId,
        disabled: !!isDisabled,
        "aria-expanded": !!isOpen,
        "aria-controls": panelId,
        onClick: callAll.callAllHandlers(props2.onClick, onClick),
        onFocus: callAll.callAllHandlers(props2.onFocus, onFocus),
