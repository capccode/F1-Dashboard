...
const Wrap = forwardRef.forwardRef(function Wrap2(props, ref) {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(factory.chakra.div, { ref, className: cx.cx("chakra-wrap", className), ...rest, children: /* @__PURE__ */ jsxRuntime.jsx(
    factory.chakra.ul,
    {
  ...
  function WrapItem2(props, ref) {
    ...
    return /* @__PURE__ */ jsxRuntime.jsx(
      factory.chakra.li,
      {
        ...
        className: cx.cx("chakra-wrap__listitem", className),
        ...rest
      }
    );
  }
