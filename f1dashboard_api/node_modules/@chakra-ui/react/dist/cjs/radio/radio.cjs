...
var split = require('@chakra-ui/utils/split');
...
const Radio = forwardRef.forwardRef((props, ref) => {
  ...
  if (group?.onChange && valueProp != null) {
    onChange = callAll.callAll(group.onChange, onChangeProp);
  }
  ...
  const [layoutProps, otherProps] = split.split(htmlProps, styledSystem.layoutPropNames);
