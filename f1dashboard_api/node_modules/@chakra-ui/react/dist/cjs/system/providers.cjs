...
const [StylesProvider, useStyles] = context.createContext({
  name: "StylesContext",
...
function GlobalStyle() {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(
    ...
    {
      styles: (theme) => {
        const styleObjectOrFn = get.memoizedGet(theme, "styles.global");
        const globalStyles = runIfFn.runIfFn(styleObjectOrFn, { theme, colorMode });
        if (!globalStyles)
          return void 0;
