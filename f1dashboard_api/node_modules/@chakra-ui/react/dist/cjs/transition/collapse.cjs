...
const Collapse = react.forwardRef(
  (props, ref) => {
    ...
    return /* @__PURE__ */ jsxRuntime.jsx(framerMotion.AnimatePresence, { initial: false, custom, children: show && /* @__PURE__ */ jsxRuntime.jsx(
      framerMotion.motion.div,
      {
        ref,
        ...rest,
        className: cx.cx("chakra-collapse", className),
        style: {
          overflow: "hidden",
          display: "block",
          ...style
