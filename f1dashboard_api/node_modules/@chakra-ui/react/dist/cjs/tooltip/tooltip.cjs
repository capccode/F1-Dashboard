...
var pick = require('@chakra-ui/utils/pick');
...
const Tooltip = forwardRef.forwardRef((props, ref) => {
  ...
  const tooltipProps = hasAriaLabel ? omit.omit(_tooltipProps, ["role", "id"]) : _tooltipProps;
  const srOnlyProps = pick.pick(_tooltipProps, ["role", "id"]);
  if (!label) {
    return /* @__PURE__ */ jsxRuntime.jsx(jsxRuntime.Fragment, { children });
  }
  return /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
    trigger,
    /* @__PURE__ */ jsxRuntime.jsx(framerMotion.AnimatePresence, { children: tooltip.isOpen && /* @__PURE__ */ jsxRuntime.jsx(portal.Portal, { ...portalProps, children: /* @__PURE__ */ jsxRuntime.jsx(
      factory.chakra.div,
      {
