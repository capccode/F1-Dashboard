...
const [ToastOptionProvider, useToastOptionContext] = context.createContext({
  ...
  const toastList = stateKeys.map((position) => {
    ...
    return /* @__PURE__ */ jsxRuntime.jsx(
      "div",
      {
        ...
        children: /* @__PURE__ */ jsxRuntime.jsx(framerMotion.AnimatePresence, { initial: false, children: toasts.map((toast) => /* @__PURE__ */ jsxRuntime.jsx(
          Component,
          {
            motionVariants,
            ...toast
